...
allowed-tools:
  - Bash
  - Read
compatibility: "macOS only — requires macOS Keychain for cookie decryption"
---
...
- Imported cookies have the same expiration as in your real browser
- When cookies expire, re-run this skill to import fresh ones
- If you get logged out during a QA session, re-import cookies for the affected domain: `$B cookie-import-browser comet --domain example.com`
- For long QA sessions, import cookies at the start of each session rather than relying on stale sessions
