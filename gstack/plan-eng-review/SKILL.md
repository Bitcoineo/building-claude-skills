...
1. **"Plan is too vague"** — Ask the user to describe the specific files and codepaths they expect to change. Cannot review what isn't concrete.
2. **"Scope unclear"** — If the plan doesn't have clear boundaries, run Step 0 Scope Challenge more aggressively. Ask: "What is explicitly NOT in scope?"
3. **"No tests in plan"** — If the plan has zero test mentions, flag this immediately in Step 0 as a blocking concern, not in Section 3.
