...
Reference for Step 4 of the scroll-stop-builder workflow. Each section below contains the
HTML structure, CSS styling, and JavaScript behavior for one website section. Read the
relevant section when building that part of the site.
